...
<?=form_open(base_url('/index.php/monitor/register_user'))?>
Nome: <input name='nome' value="<?=$nome?>" type="text" style="width: 200px;" />
Login: <input name='login' value="<?=$login?>" type="text" style="width: 120px;" onchange="document.getElementById('email_form').value = (this.value)+'@cin.ufpe.br'"/>
...
<input type="checkbox" name="grant_access" value="1" <?=($grant_access == '1' ? 'checked' : '')?> > Marque esta opção para cadastrar como <strong>Monitor</strong>.
